...
public class MapGenerator : MonoBehaviour
{
    ...
    private const int MAP_SIZE = 15; //マップの一辺のマス数。偶数にしないでください。自動デバッグしようとしたらunreachable code警告が消えない:(
    ...
    private void GenerateMap()
    {
        ...
        TextAsset[] textAsset_array = {
            Resources.Load("7x7MapPart001") as TextAsset,
            Resources.Load("7x7MapPart002") as TextAsset,
            Resources.Load("7x7MapPart003") as TextAsset,
            Resources.Load("7x7MapPart004") as TextAsset};
